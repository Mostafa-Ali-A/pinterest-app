				...
				<nav className='w-full flex items-center'>
					...
					{session?.user ? (
						<button
							...
							<div className='flex-col'>
								<p className='mt-1.5 mr-3 text-xs'>{session?.user?.name}</p>
								<p className='mb-.5 font-medium'>{session?.user?.name}</p>
							</div>
							<div>
								<svg
						...
						<button
							...
							<div className='flex-col'>
								<p className='mt-1.5 mr-3 text-xs'>Login</p>
								<p className='mb-.5 font-medium'>Login</p>
							</div>
							<div>
								<svg
									className='w-3 h-3 mt-0.5 mx-3 text-black'
					...
					<section
						...
						{session ? (
							...
							<>
								<p className='pt-2'>Not signed in </p>
								<br />
								<button
									className='w-80 rounded-md p-2 hover:bg-gray-200'
									onClick={() => signIn()}>
